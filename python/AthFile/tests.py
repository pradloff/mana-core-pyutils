...
class AthFileTest(unittest.TestCase):
    ...
    def test001(self):
        ...
        import PyUtils.AthFile as af
        fname = 'root://castoratlas//castor/cern.ch/user/b/binet/regr-tests/athfile/esd.gcc34.15.1.x.pool.root'
        assert af.ftype(fname) == ('pool', 'root://castoratlas//castor/cern.ch/user/b/binet/regr-tests/athfile/esd.gcc34.15.1.x.pool.root')
    ...
    def test006(self):
        ...
        import PyUtils.AthFile as af
        fname = 'root://castoratlas//castor/cern.ch/user/b/binet/regr-tests/athfile/testSim.0011.mu_pt5_eta60.EVGEN.pool.root'

        assert af.exists(fname)
        assert af.ftype(fname) == ('pool', 'root://castoratlas//castor/cern.ch/user/b/binet/regr-tests/athfile/testSim.0011.mu_pt5_eta60.EVGEN.pool.root')
        f6 = af.fopen(fname)
        if verbose:
            print "::: f6.fileinfos:"
            print f6.fileinfos
        f6_ref = {'file_md5sum':'b6b58e325235b4fbbf0aebd5e028ab08', 'metadata_items': [], 'stream_names': ['Stream1'], 'run_type': ['N/A'], 'stream_tags': [], 'tag_info': {'AtlasRelease': 'any'}, 'file_type': 'pool', 'file_name': 'root://castoratlas//castor/cern.ch/user/b/binet/regr-tests/athfile/testSim.0011.mu_pt5_eta60.EVGEN.pool.root', 'file_guid': 'ACC40752-51BB-DB11-8437-000423D65662', 'beam_type': ['N/A'], 'lumi_block': [0L], 'conditions_tag': None, 'det_descr_tags': {'AtlasRelease': 'any'}, 'nentries': 1053L, 'eventdata_items': [('EventInfo', 'McEventInfo'), ('McEventCollection', 'GEN_EVENT'), ('DataHeader', 'Stream1')], 'run_number': [11L], 'beam_energy': ['N/A'], 'geometry': None, 'evt_number': [1L], 'evt_type': ('IS_SIMULATION', 'IS_ATLAS', 'IS_PHYSICS'), 'metadata': {}}
    ...
    def test008(self):
        ...
        fname="root://castoratlas//castor/cern.ch/atlas/atlascerngroupdisk/trig-daq/validation/test_data/valid1.005640.CharybdisJimmy.digit.RDO.e322_s483/RDO.027377._00069.pool.root.3"

        assert af.exists(fname)
        assert af.ftype(fname) == ('pool', 'root://castoratlas//castor/cern.ch/atlas/atlascerngroupdisk/trig-daq/validation/test_data/valid1.005640.CharybdisJimmy.digit.RDO.e322_s483/RDO.027377._00069.pool.root.3')
    ...
    def test009(self):
        ...
        for fname in [
            "root://castoratlas//castor/cern.ch/user/b/binet/utests/athfile/TAG.102229._000001.pool.root.1"
            ]:
            assert af.exists(fname), "problem with filename [%s]" % fname
    ...
    def test010(self):
        """test TAG file"""
        import PyUtils.AthFile as af
        fname = "root://castoratlas//castor/cern.ch/user/b/binet/utests/athfile/TAG.102229._000001.pool.root.1"
        assert af.exists(fname)
        assert af.ftype(fname) == (
            'pool',
            'root://castoratlas//castor/cern.ch/user/b/binet/utests/athfile/TAG.102229._000001.pool.root.1')
